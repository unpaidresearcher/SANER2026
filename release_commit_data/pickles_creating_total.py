...
for project in projects:
    ...
    our_csv1 = pd.read_csv(f"{project}_tag_commits_diff_total.csv")
    all_common_rows = []
    ...
    for id, tag_their in enumerate(all_tags_their[project]):
        ...
        our_tag_df1 = our_csv[our_csv["Tag"] == tag_our]
        ...
        for file in common_files:
            ...
            file_df = our_tag_df1[our_tag_df1["File"] == file]
            ...
            for commit_id in file_df["Commit ID"].unique():
                ...
                if commit_id not in commit_author_lines:
                    commit_author_lines[commit_id] = {}

                for _, row in commit_df.iterrows():
                    author = row["Author"]
                    total_lines = row["Lines Added"] + row["Lines Deleted"]

                    commit_author_lines[commit_id][author] = (
                            commit_author_lines[commit_id].get(author, 0) + total_lines
                    )
        ...
        pickle.dump(file_bugs, open(os.path.join(pickle_dir, "file_bugs_total.pkl"), "wb"))
        pickle.dump(commits, open(os.path.join(pickle_dir, "commits_total.pkl"), "wb"))
        pickle.dump(commit_set_of_files, open(os.path.join(pickle_dir, "commit_set_of_files_total.pkl"), "wb"))
        pickle.dump(file_commits, open(os.path.join(pickle_dir, "file_commits_total.pkl"), "wb"))
        pickle.dump(commit_authors, open(os.path.join(pickle_dir, "commit_authors_total.pkl"), "wb"))
        pickle.dump(file_authors, open(os.path.join(pickle_dir, "file_authors_total.pkl"), "wb"))
        pickle.dump(file_authors_distinct, open(os.path.join(pickle_dir, "file_authors_distinct_total.pkl"), "wb"))
        pickle.dump(file_lines_added, open(os.path.join(pickle_dir, "file_lines_added_total.pkl"), "wb"))
        pickle.dump(file_lines_deleted, open(os.path.join(pickle_dir, "file_lines_deleted_total.pkl"), "wb"))
        pickle.dump(author_lines_added, open(os.path.join(pickle_dir, "author_lines_added_total.pkl"), "wb"))
        pickle.dump(author_lines_deleted, open(os.path.join(pickle_dir, "author_lines_deleted_total.pkl"), "wb"))
        pickle.dump(commit_lines_added, open(os.path.join(pickle_dir, "commit_lines_added_total.pkl"), "wb"))
        pickle.dump(commit_lines_deleted, open(os.path.join(pickle_dir, "commit_lines_deleted_total.pkl"), "wb"))
        pickle.dump(commit_author_lines, open(os.path.join(pickle_dir, "commit_author_lines_total.pkl"), "wb"))
        pickle.dump(file_commit_authors, open(os.path.join(pickle_dir, "file_commit_authors_total.pkl"), "wb"))

        print(f"Pickles saved for {project} | {tag_our}")

    csv_path = os.path.join(output_dir, f"{project}_common_files_total.csv")
